...
namespace Massive
{
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
        {
            ...
            //build the SQL
            string sql = String.Format("SELECT TOP 1 {0} FROM {1}{2}", columns, TableName, where);
            ...
            {
                //default to multiple
                sql = String.Format("SELECT {0} FROM {1}{2}", columns, TableName, where);
            }
